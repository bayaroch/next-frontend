...
export default {
  ...
  AUTOMATION: {
    ...
    when: 'When ...',
    comments_on_posts: 'User comments on posts',
    any_posts_desc: 'Works when for all posts',
    this_posts_desc: 'Works on this specific post',
    then: 'Then',
    send_response: 'Sends response',
    facebook: 'Facebook',
    comment: 'Comment',
    next_step: 'Next step',
    analysis_comment: 'Analysis comment',
    chooses_keyword: 'Ai chooses correct keyword',
    only_instant: 'Only instant response',
